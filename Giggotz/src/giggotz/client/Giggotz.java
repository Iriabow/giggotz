...
public class Giggotz implements EntryPoint {
	...
	public static void go(String token, Map<String,Object> params){
		...
		if(token.equals("spotifyWikipedia")){
			//creamos un boolean para resolver el conflicto de la primera vez necesitar a�adir la vista
			//y el resto que clicamos un concierto borrar y volver a a�adir la vista
